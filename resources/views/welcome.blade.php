...
<body class="antialiased">
    ...
    {{-- ═══ FLOATING WHATSAPP ═══ --}}
    <a href="https://wa.me/6281210534627?text=Halo%20Light%20Star%20Media%2C%20saya%20ingin%20bertanya%20terkait%20layanan%20yang%20tersedia.%20Jika%20sesuai%20dengan%20kebutuhan%20saya%2C%20saya%20berminat%20untuk%20melakukan%20pemesanan.%20Mohon%20informasi%20lebih%20lanjut.%20Terima%20kasih." target="_blank" class="whatsapp-float" aria-label="Chat WhatsApp">
            ...
            <div class="space-y-3 sm:space-y-4 fade-up">
                @php
                    $faqs = [
                        ...
                        [
                            'q' => 'Apa yang dimaksud dengan layanan Hybrid Event Production?',
                            'a' =>
                                'Layanan ini memungkinkan acara Anda berlangsung secara tatap muka (fisik) sekaligus disiarkan secara daring (virtual) dengan standar produksi profesional agar audiens di kedua lokasi mendapatkan kualitas pengalaman yang sama baiknya.',
                        ],
                        [
                            'q' => 'Platform apa saja yang didukung untuk Live Streaming?',
                            'a' =>
                                'Kami ahli dalam integrasi multi-platform, mulai dari Zoom Pro, YouTube Live, Instagram, hingga platform global lainnya secara bersamaan (simultaneous streaming).',
                        ],
                        [
                            'q' => 'Bagaimana prosedur pemesanan jadwal dan booking?',
                            'a' =>
                                'Konfirmasi jadwal dan booking dianggap sah setelah Anda melakukan pembayaran uang muka (DP) sebesar 50% dari total nilai kontrak.',
                        ],
                        [
                            'q' => 'Kapan batas waktu pelunasan biaya layanan?',
                            'a' =>
                                'Pelunasan wajib dilakukan maksimal H-1 sebelum pelaksanaan event dimulai.',
                        ],
                        [
                            'q' => 'Bagaimana jika ada perubahan jadwal atau pembatalan?',
                            'a' =>
                                'Perubahan jadwal pada H-3 dapat dikenakan biaya penyesuaian kru dan perangkat produksi. Perlu diperhatikan bahwa jika terjadi pembatalan setelah pembayaran DP, maka DP dinyatakan hangus.',
                        ],
                        [
                            'q' => 'Apakah ada biaya tambahan untuk lokasi di luar Jakarta?',
                            'a' =>
                                'Benar, biaya transportasi dan akomodasi untuk lokasi di luar wilayah Jabodetabek akan disesuaikan dengan kebutuhan teknis di lapangan.',
                        ],
                        [
                            'q' => 'Apakah dengan membayar DP saya otomatis menyetujui aturan ini?',
                            'a' =>
                                'Ya, dengan melakukan pembayaran, Anda dianggap telah membaca dan menyetujui semua kebijakan serta standar prosedur operasi kami.',
                        ],
                    ];
                @endphp
                @foreach ($faqs as $faq)
